...
${THOME}/build/dobuild -64 libpsl-0.23.0 -C "--disable-static --disable-dependency-tracking --enable-builtin --disable-runtime --with-psl-file=/tmp/psl/public_suffix_list.dat"
${THOME}/build/genpkg TRIBlibpsl libpsl-0.23.0
