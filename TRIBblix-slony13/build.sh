...
#
$THOME/build/dobuild +64only slony1-2.2.11 -P /opt/tribblix/postgres13 -C "--with-pgconfigdir=/opt/tribblix/postgres13/bin --sysconfdir=/etc"
$THOME/build/genpkg TRIBblix-slony13 slony1-2.2.11
