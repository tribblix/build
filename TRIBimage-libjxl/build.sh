...
#
${THOME}/build/cmbuild -64only libjxl-0.10.3 -C "-DBUILD_TESTING=OFF -DJPEGXL_FORCE_SYSTEM_BROTLI=TRUE -DJPEGXL_FORCE_SYSTEM_LCMS2=TRUE -DJPEGXL_ENABLE_PLUGINS=TRUE"
