...
openssl md5 ${THOME}/pkgs/TRIBjproc.1.4.zap | /usr/bin/awk '{print $NF}' > ${THOME}/pkgs/TRIBjproc.1.4.zap.md5
openssl md5 ${THOME}/pkgs.sparc/TRIBjproc.1.4.zap | /usr/bin/awk '{print $NF}' > ${THOME}/pkgs.sparc/TRIBjproc.1.4.zap.md5
${THOME}/build/sign-file ${THOME}/pkgs/TRIBjproc.1.4.zap
${THOME}/build/sign-file ${THOME}/pkgs.sparc/TRIBjproc.1.4.zap
