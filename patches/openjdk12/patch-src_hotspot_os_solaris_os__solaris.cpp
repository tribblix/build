...
@@ -2267,7 +2269,7 @@ void os::pd_commit_memory_or_exit(char*
...
@@ -2296,7 +2298,7 @@ void os::pd_realign_memory(char *addr, s
...
@@ -2304,7 +2306,7 @@ void os::numa_make_local(char *addr, siz
