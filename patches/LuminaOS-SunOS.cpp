...
QString LOS::OSName(){ return "illumos"; }
...
//File Checksums
QStringList LOS::Checksums(QStringList filepaths){ //QStringList filepaths
...
QString LOS::FileSystemCapacity(QString dir) { //QString directory path
  QStringList mountInfo = LUtils::getCmdOutput("df -k \"" + dir+"\"");
