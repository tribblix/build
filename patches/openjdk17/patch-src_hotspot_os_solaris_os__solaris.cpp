...
@@ -1848,7 +1848,7 @@ void os::pd_commit_memory_or_exit(char*
...
@@ -1877,7 +1877,7 @@ void os::pd_realign_memory(char *addr, s
...
@@ -1885,7 +1885,7 @@ void os::numa_make_local(char *addr, siz
