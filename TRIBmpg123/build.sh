#!/bin/sh
#
env TRIBBLIX_CFLAGS="-D__EXTENSIONS__ -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64" ${THOME}/build/dobuild -64 mpg123-1.32.3 \
...
#
${THOME}/build/genpkg TRIBmpg123 mpg123-1.32.3
