...
#
env PATH=/opt/tribblix/postgres15/bin:$PATH LD_RUN_PATH=/opt/tribblix/postgres15/lib $THOME/build/pkg_setup_py TRIBpsycopg-311 psycopg-3.1.19 psycopg_pool-3.2.2 psycopg_c-3.1.19
