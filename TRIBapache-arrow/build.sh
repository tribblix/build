...
#
$THOME/build/cmbuild -64only -S cpp apache-arrow-25.0.0 -C "-DARROW_JEMALLOC=OFF -DARROW_BUILD_STATIC=OFF -DARROW_COMPUTE=ON -DARROW_FILESYSTEM=ON -DARROW_CSV=ON -DARROW_DATASET=ON -DARROW_JSON=ON -DARROW_PARQUET=ON -DCMAKE_PREFIX_PATH=/usr/lib/`$THOME/build/getarch`/cmake"
${THOME}/build/genpkg TRIBapache-arrow apache-arrow-25.0.0
