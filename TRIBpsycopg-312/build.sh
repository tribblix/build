...
#
env LDFLAGS=-R/opt/tribblix/postgres17/lib PATH=/opt/tribblix/postgres17/bin:$PATH $THOME/build/pkg_setup_py TRIBpsycopg-312 psycopg-3.2.9 psycopg_pool-3.2.6 psycopg_c-3.2.9
