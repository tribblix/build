...
#
cd ~/ud
${THOME}/build/unpack jdk18-jdk-18-36
cd jdk18-jdk-18-36
...
# OpenJDK Runtime Environment (build 18-internal+0-adhoc.ptribble.jdk18-jdk-18-36)
# OpenJDK 64-Bit Server VM (build 18-internal+0-adhoc.ptribble.jdk18-jdk-18-36, mixed mode, sharing)
#
