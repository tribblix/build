...
cd ~/ud
${THOME}/build/unpack jdk21u-jdk-21.0.12-ga
cd jdk21u-jdk-21.0.12-ga
...
#
# openjdk version "21.0.12-ga" 2026-07-21
# OpenJDK Runtime Environment (build 21.0.12-ga-Tribblix)
# OpenJDK 64-Bit Server VM (build 21.0.12-ga-Tribblix, mixed mode, sharing)
#
