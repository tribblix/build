...
cd ~/ud
${THOME}/build/unpack jdk21u-jdk-21.0.3-ga
cd jdk21u-jdk-21.0.3-ga
...
# ./bin/java -version
#
# openjdk version "21.0.3-internal" 2024-04-16
# OpenJDK Runtime Environment (build 21.0.3-internal-adhoc.ptribble.jdk21u-jdk-21.0.3-ga)
# OpenJDK 64-Bit Server VM (build 21.0.3-internal-adhoc.ptribble.jdk21u-jdk-21.0.3-ga, mixed mode, sharing)
#
