...
cd ~/ud
${THOME}/build/unpack jdk21u-jdk-21.0.12.1-ga
cd jdk21u-jdk-21.0.12.1-ga
...
#
# openjdk version "21.0.12.1-ga" 2026-08-18
# OpenJDK Runtime Environment (build 21.0.12.1-ga-Tribblix)
# OpenJDK 64-Bit Server VM (build 21.0.12.1-ga-Tribblix, mixed mode, sharing)
#
