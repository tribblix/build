...
#
env LDFLAGS=-m64 CXXFLAGS="-m64 -D__STDC_NO_ATOMICS__=1" CFLAGS=-m64 PATH=/usr/versions/python-3.13/bin:$PATH ${THOME}/build/pkg_pep518 -N TRIBscikit-image-python-313 scikit_image-0.26.0
