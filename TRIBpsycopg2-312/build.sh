...
#
env LDFLAGS=-R/opt/tribblix/postgres17/lib PATH=/opt/tribblix/postgres17/bin:$PATH $THOME/build/pkg_setup_py TRIBpsycopg2-312 psycopg2-2.9.10 psycopg2-binary-2.9.10
