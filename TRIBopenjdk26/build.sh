...
${THOME}/build/unpack jdk-jdk-26-35
cd jdk-jdk-26-35
...
#
# openjdk version "26-35" 2026-03-17
# OpenJDK Runtime Environment (build 26-35-Tribblix)
# OpenJDK 64-Bit Server VM (build 26-35-Tribblix, mixed mode, sharing)
#
