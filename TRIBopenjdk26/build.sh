...
${THOME}/build/unpack jdk26u-jdk-26.0.2.1-ga
cd jdk26u-jdk-26.0.2.1-ga
...
#
# openjdk version "26.0.2.1-ga" 2026-08-18
# OpenJDK Runtime Environment (build 26.0.2.1-ga-Tribblix)
# OpenJDK 64-Bit Server VM (build 26.0.2.1-ga-Tribblix, mixed mode, sharing)
#
