...
#
${THOME}/build/dobuild ghostscript-9.23 -C "--disable-compile-inits --with-system-libtiff --disable-gtk --disable-dbus --disable-cups --enable-dynamic LIBS=-lz"
cd ghostscript-9.23
gmake -j4 so
rm -fr /tmp/ags
...
tar cf - examples | ( cd /tmp/ags/usr/share/ghostscript/9.23 ; tar xf -)
