...
cd ~/ud
${THOME}/build/unpack jdk-jdk-16-23
cd jdk-jdk-16-23
...
# OpenJDK Runtime Environment (build 16-internal+0-adhoc.ptribble.jdk-jdk-16-23)
# OpenJDK 64-Bit Server VM (build 16-internal+0-adhoc.ptribble.jdk-jdk-16-23, mixed mode, sharing)
#
