...
cd ~/ud
${THOME}/build/unpack jdk16-jdk-16-33
cd jdk16-jdk-16-33
...
# OpenJDK Runtime Environment (build 16-internal+0-adhoc.ptribble.jdk16-jdk-16-33)
# OpenJDK 64-Bit Server VM (build 16-internal+0-adhoc.ptribble.jdk16-jdk-16-33, mixed mode, sharing)
#
