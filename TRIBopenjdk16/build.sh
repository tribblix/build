...
cd ~/ud
${THOME}/build/unpack jdk-jdk-16-26
cd jdk-jdk-16-26
...
# OpenJDK Runtime Environment (build 16-internal+0-adhoc.ptribble.jdk-jdk-16-26)
# OpenJDK 64-Bit Server VM (build 16-internal+0-adhoc.ptribble.jdk-jdk-16-26, mixed mode, sharing)
#
