...
#
cd ${THOME}/tarballs
wget http://hg.openjdk.java.net/jdk/jdk/archive/jdk-16+12.tar.bz2
ln jdk-16+12.tar.bz2 jdk-jdk-16+12.tar.bz2

cd ~/ud
${THOME}/build/unpack jdk-jdk-16+12
cd jdk-jdk-16+12
...
# OpenJDK Runtime Environment (build 16-internal+0-adhoc.ptribble.jdk-jdk-1612)
# OpenJDK 64-Bit Server VM (build 16-internal+0-adhoc.ptribble.jdk-jdk-1612, mixed mode, sharing)
#
