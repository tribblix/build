...
#
cd ~/ud
${THOME}/build/unpack jdk17u-jdk-17.0.20-ga
cd jdk17u-jdk-17.0.20-ga
...
#
# openjdk version "17.0.20-ga" 2026-07-21
# OpenJDK Runtime Environment (build 17.0.20-ga+0-Tribblix)
# OpenJDK 64-Bit Server VM (build 17.0.20-ga+0-Tribblix, mixed mode, sharing)
#
