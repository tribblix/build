...
#
cd ~/ud
${THOME}/build/unpack jdk17-jdk-17-30
cd jdk17-jdk-17-30
...
# OpenJDK Runtime Environment (build 17-internal+0-adhoc.ptribble.jdk17-jdk-17-30)
# OpenJDK 64-Bit Server VM (build 17-internal+0-adhoc.ptribble.jdk17-jdk-17-30, mixed mode, sharing)
#
