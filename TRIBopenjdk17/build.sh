...
#
cd ~/ud
${THOME}/build/unpack jdk17-jdk-17-28
cd jdk17-jdk-17-28
...
# OpenJDK Runtime Environment (build 17-internal+0-adhoc.ptribble.jdk17-jdk-17-28)
# OpenJDK 64-Bit Server VM (build 17-internal+0-adhoc.ptribble.jdk17-jdk-17-28, mixed mode, sharing)
#
