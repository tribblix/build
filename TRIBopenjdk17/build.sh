...
#
cd ~/ud
${THOME}/build/unpack jdk17-jdk-17-33
cd jdk17-jdk-17-33
...
# OpenJDK Runtime Environment (build 17-internal+0-adhoc.ptribble.jdk17-jdk-17-33)
# OpenJDK 64-Bit Server VM (build 17-internal+0-adhoc.ptribble.jdk17-jdk-17-33, mixed mode, sharing)
#
