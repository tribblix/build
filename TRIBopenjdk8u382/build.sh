...
# eg
# https://openjdk-sources.osci.io/openjdk8/openjdk8u382-ga.tar.xz
#
# check the build number corresponding to GA here
# https://github.com/openjdk/jdk8u/tags
# ga for 8u382 was b05
#
cd ~/ud
${THOME}/build/unpack jdk8u-jdk8u382-ga
...
rm -fr /tmp/jdk
mkdir -p /tmp/jdk/usr/versions/openjdk1.8.0_382
mkdir -p /tmp/jdk/usr/jdk/instances
(cd build/solaris-x86_64-normal-server-release/images/j2sdk-image; tar cf - *) | ( cd /tmp/jdk/usr/versions/openjdk1.8.0_382 ; tar xf -)
cd /tmp/jdk/usr/jdk/instances
ln -s ../../versions/openjdk1.8.0_382 jdk1.8.0
cd /tmp/jdk/usr/jdk
ln -s ../versions/openjdk1.8.0_382 .
# latest is now jdk11
#ln -s openjdk1.8.0_382 latest
...
#rm `find . -name '*.diz'`
cp /tmp/cacerts /tmp/jdk/usr/versions/openjdk1.8.0_382/jre/lib/security
...
${THOME}/build/create_pkg TRIBopenjdk8u382 /tmp/jdk
