...
cd ~/ud
${THOME}/build/unpack jdk20-jdk-20-31
cd jdk20-jdk-20-31
...
# OpenJDK Runtime Environment (build 20-internal-adhoc.ptribble.jdk20-jdk-20-31)
# OpenJDK 64-Bit Server VM (build 20-internal-adhoc.ptribble.jdk20-jdk-20-31, mixed mode, sharing)
#
