...
cd ~/ud
${THOME}/build/unpack jdk20-jdk-20-33
cd jdk20-jdk-20-33
...
# OpenJDK Runtime Environment (build 20-internal-adhoc.ptribble.jdk20-jdk-20-33)
# OpenJDK 64-Bit Server VM (build 20-internal-adhoc.ptribble.jdk20-jdk-20-33, mixed mode, sharing)
#
