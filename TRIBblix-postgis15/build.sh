...
#
$THOME/build/dobuild +64only postgis-3.5.2 -P /opt/tribblix/postgres15 -C "--with-pgconfig=/opt/tribblix/postgres15/bin/pg_config --sysconfdir=/etc"
$THOME/build/genpkg TRIBblix-postgis15 postgis-3.5.2
