...
${THOME}/build/unpack XML-Parser-2.54
...
make
cd ..
${THOME}/build/genpkg TRIBlib-perl-5-xml-parser XML-SAX-Base-1.09 XML-NamespaceSupport-1.12 XML-SAX-1.02 XML-Parser-2.54 XML-SAX-Expat-0.51 XML-Simple-2.25
