...
cd ..
${THOME}/build/dobuild subversion-1.9.5 -P /usr/versions/subversion-1.9 -C "--with-apr=../apr-1.5.2 --with-apr-util=../apr-util-1.5.4 --with-serf=../serf-1.3.8 CPPFLAGS=-D__EXTENSIONS__" -L
...
${THOME}/build/genpkg TRIBv-subversion-19 subversion-1.9.5 apr-1.5.2 apr-util-1.5.4
# [phew]
