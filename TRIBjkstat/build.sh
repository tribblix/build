...
openssl md5 ${THOME}/pkgs/TRIBjkstat.1.5.0.zap | /usr/bin/awk '{print $NF}' > ${THOME}/pkgs/TRIBjkstat.1.5.0.zap.md5
openssl md5 ${THOME}/pkgs.sparc/TRIBjkstat.1.5.0.zap | /usr/bin/awk '{print $NF}' > ${THOME}/pkgs.sparc/TRIBjkstat.1.5.0.zap.md5
${THOME}/build/sign-file ${THOME}/pkgs/TRIBjkstat.1.5.0.zap
${THOME}/build/sign-file ${THOME}/pkgs.sparc/TRIBjkstat.1.5.0.zap
