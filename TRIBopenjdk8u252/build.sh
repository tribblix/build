...
#
cd /tmp
wget http://hg.openjdk.java.net/jdk8u/jdk8u/archive/jdk8u252-b09.tar.bz2
foreach file ( corba hotspot jaxp jaxws langtools jdk nashorn )
wget http://hg.openjdk.java.net/jdk8u/jdk8u/${file}/archive/jdk8u252-b09.tar.bz2 -O ${file}-jdk8u252-b09.tar.bz2
end
pbzcat jdk8u252-b09.tar.bz2 | tar xf -
mv jdk8u-jdk8u252-b09 openjdk8u252
foreach file ( corba hotspot jaxp jaxws langtools jdk nashorn )
pbzcat ${file}-jdk8u252-b09.tar.bz2 | tar xf -
mv ${file}-jdk8u252-b09 openjdk8u252/$file
end
tar cf ${THOME}/tarballs/openjdk8u252.tar openjdk8u252
pbzip2 ${THOME}/tarballs/openjdk8u252.tar

cd ~/ud
${THOME}/build/unpack openjdk8u252
cd openjdk8u252
...
#
env PATH=${HOME}/sunstudio12.1/bin:/usr/bin:/usr/sbin bash ./configure --with-milestone=fcs --with-update-version=252 --with-build-number=b09 --enable-unlimited-crypto
...
rm -fr /tmp/jdk
mkdir -p /tmp/jdk/usr/versions/openjdk1.8.0_252
mkdir -p /tmp/jdk/usr/jdk/instances
(cd build/solaris-x86_64-normal-server-release/images/j2sdk-image; tar cf - *) | ( cd /tmp/jdk/usr/versions/openjdk1.8.0_252 ; tar xf -)
cd /tmp/jdk/usr/jdk/instances
ln -s ../../versions/openjdk1.8.0_252 jdk1.8.0
cd /tmp/jdk/usr/jdk
ln -s ../versions/openjdk1.8.0_252 .
ln -s openjdk1.8.0_252 latest
...
rm `find . -name '*.diz'`
cp /tmp/cacerts /tmp/jdk/usr/versions/openjdk1.8.0_252/jre/lib/security
...
${THOME}/build/create_pkg TRIBopenjdk8u252 /tmp/jdk
