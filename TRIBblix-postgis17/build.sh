...
#
$THOME/build/dobuild +64only postgis-3.5.2 -P /opt/tribblix/postgres17 -C "--with-pgconfig=/opt/tribblix/postgres17/bin/pg_config --sysconfdir=/etc"
$THOME/build/genpkg TRIBblix-postgis17 postgis-3.5.2
