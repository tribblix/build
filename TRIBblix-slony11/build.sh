...
#
$THOME/build/dobuild slony1-2.2.11 -P /opt/tribblix/postgres11 -C "--with-pgconfigdir=/opt/tribblix/postgres11/bin --sysconfdir=/etc"
$THOME/build/genpkg TRIBblix-slony11 slony1-2.2.11
