...
cd ~/ud
${THOME}/build/unpack jdk11u-jdk-11.0.32.1-ga
cd jdk11u-jdk-11.0.32.1-ga
...
#
# ./build/solaris-x86_64-normal-server-release/images/jdk/bin/java -version
#
# openjdk version "11.0.32.1-internal" 2026-08-18
# OpenJDK Runtime Environment (build 11.0.32.1-internal+0-adhoc.ptribble.jdk11u-jdk-11.0.32.1-ga)
# OpenJDK 64-Bit Server VM (build 11.0.32.1-internal+0-adhoc.ptribble.jdk11u-jdk-11.0.32.1-ga, mixed mode)
#
