...
cd ~/ud
${THOME}/build/unpack jdk11u-jdk-11.0.32-ga
cd jdk11u-jdk-11.0.32-ga
...
# OpenJDK Runtime Environment (build 11.0.32-internal+0-adhoc.ptribble.jdk11u-jdk-11.0.32-ga)
# OpenJDK 64-Bit Server VM (build 11.0.32-internal+0-adhoc.ptribble.jdk11u-jdk-11.0.32-ga, mixed mode)
#
