...
cd ~/ud
${THOME}/build/unpack jdk11u-jdk-11.0.16-ga
cd jdk11u-jdk-11.0.16-ga
...
# OpenJDK Runtime Environment (build 11.0.16-internal+0-adhoc.ptribble.jdk11u-jdk-11.0.16-ga)
# OpenJDK 64-Bit Server VM (build 11.0.16-internal+0-adhoc.ptribble.jdk11u-jdk-11.0.16-ga, mixed mode)
#
