...
cd ~/ud
${THOME}/build/unpack jdk11u-jdk-11.0.17-ga
cd jdk11u-jdk-11.0.17-ga
...
# ./bin/java -version
#
# openjdk version "11.0.17-internal" 2022-07-19
# OpenJDK Runtime Environment (build 11.0.17-internal+0-adhoc.ptribble.jdk11u-jdk-11.0.17-ga)
# OpenJDK 64-Bit Server VM (build 11.0.17-internal+0-adhoc.ptribble.jdk11u-jdk-11.0.17-ga, mixed mode)
#
