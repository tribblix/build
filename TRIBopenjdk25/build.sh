...
cd ~/ud
${THOME}/build/unpack jdk25u-jdk-25.0.4.1-ga
cd jdk25u-jdk-25.0.4.1-ga
...
#
# openjdk version "25.0.4.1-ga" 2026-08-18
# OpenJDK Runtime Environment (build 25.0.4.1-ga-Tribblix)
# OpenJDK 64-Bit Server VM (build 25.0.4.1-ga-Tribblix, mixed mode, sharing)
#
