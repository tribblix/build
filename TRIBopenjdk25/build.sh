...
cd ~/ud
${THOME}/build/unpack jdk25u-jdk-25.0.4-ga
cd jdk25u-jdk-25.0.4-ga
...
#
# openjdk version "25.0.4-ga" 2026-07-21
# OpenJDK Runtime Environment (build 25.0.4-ga-Tribblix)
# OpenJDK 64-Bit Server VM (build 25.0.4-ga-Tribblix, mixed mode, sharing)
#
