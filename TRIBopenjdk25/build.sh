...
cd ~/ud
${THOME}/build/unpack jdk-jdk-25-33
cd jdk-jdk-25-33
...
# OpenJDK Runtime Environment (build 25-internal-adhoc.ptribble.jdk-jdk-25-33)
# OpenJDK 64-Bit Server VM (build 25-internal-adhoc.ptribble.jdk-jdk-25-33, mixed mode, sharing)
#
