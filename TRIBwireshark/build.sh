...
#
#env TRIBBLIX_LDFLAGS="-lsocket -lnsl" TRIBBLIX_CFLAGS="-D__EXTENSIONS__ -I/usr/include/kerberosv5" PATH=${PATH}:/usr/perl5/5.34/bin ${THOME}/build/cmbuild -64only -gnu wireshark-3.6.15 -C "-DCMAKE_INSTALL_RPATH_USE_LINK_PATH=TRUE -DBUILD_wireshark=OFF"
