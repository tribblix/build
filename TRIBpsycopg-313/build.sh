...
#
env LDFLAGS=-R/opt/tribblix/postgres17/lib PATH=/opt/tribblix/postgres17/bin:$PATH $THOME/build/pkg_pep518 -N TRIBpsycopg-313 psycopg-3.3.4 psycopg_pool-3.3.1 psycopg_c-3.3.4
