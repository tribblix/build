...
#
env PATH=${HOME}/sunstudio12.1/bin:/usr/bin:/usr/sbin bash ./configure --with-milestone=fcs --with-update-version=302 --with-build-number=b08 --enable-unlimited-crypto --with-jobs=3
