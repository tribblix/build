...
#
cd /tmp
wget http://hg.openjdk.java.net/jdk8u/jdk8u/archive/jdk8u302-b08.tar.bz2
foreach file ( corba hotspot jaxp jaxws langtools jdk nashorn )
wget http://hg.openjdk.java.net/jdk8u/jdk8u/${file}/archive/jdk8u302-b08.tar.bz2 -O ${file}-jdk8u302-b08.tar.bz2
end
pbzcat jdk8u302-b08.tar.bz2 | tar xf -
mv jdk8u-jdk8u302-b08 openjdk8u302
foreach file ( corba hotspot jaxp jaxws langtools jdk nashorn )
pbzcat ${file}-jdk8u302-b08.tar.bz2 | tar xf -
mv ${file}-jdk8u302-b08 openjdk8u302/$file
end
tar cf ${THOME}/tarballs/openjdk8u302.tar openjdk8u302
pbzip2 ${THOME}/tarballs/openjdk8u302.tar
#
cd ~/ud
${THOME}/build/unpack openjdk8u302
cd openjdk8u302
...
# eg
# https://openjdk-sources.osci.io/openjdk8/openjdk8u302-ga.tar.xz
#
# check the build number corresponding to GA here
# https://hg.openjdk.java.net/jdk8u/jdk8u
# ga for 8u302 was b08
#
cd ~/ud
${THOME}/build/unpack openjdk8u302-ga
cd jdk8u302-ga
...
#
env PATH=${HOME}/sunstudio12.1/bin:/usr/bin:/usr/sbin bash ./configure --with-milestone=fcs --with-update-version=302 --with-build-number=b08 --enable-unlimited-crypto --with-boot-jdk=/usr/jdk/instances/jdk1.8.0 --with-jobs=3
...
rm -fr /tmp/jdk
mkdir -p /tmp/jdk/usr/versions/openjdk1.8.0_302
mkdir -p /tmp/jdk/usr/jdk/instances
(cd build/solaris-x86_64-normal-server-release/images/j2sdk-image; tar cf - *) | ( cd /tmp/jdk/usr/versions/openjdk1.8.0_302 ; tar xf -)
cd /tmp/jdk/usr/jdk/instances
ln -s ../../versions/openjdk1.8.0_302 jdk1.8.0
cd /tmp/jdk/usr/jdk
ln -s ../versions/openjdk1.8.0_302 .
ln -s openjdk1.8.0_302 latest
...
rm `find . -name '*.diz'`
cp /tmp/cacerts /tmp/jdk/usr/versions/openjdk1.8.0_302/jre/lib/security
...
${THOME}/build/create_pkg TRIBopenjdk8u302 /tmp/jdk
