...
${THOME}/build/unpack jdk-jdk-27-35
cd jdk-jdk-27-35
...
#
# openjdk version "27-35" 2026-09-15
# OpenJDK Runtime Environment (build 27-35-Tribblix)
# OpenJDK 64-Bit Server VM (build 27-35-Tribblix, mixed mode, sharing)
#
