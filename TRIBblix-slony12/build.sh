...
#
$THOME/build/dobuild slony1-2.2.10 -P /opt/tribblix/postgres12 -C "--with-pgconfigdir=/opt/tribblix/postgres12/bin --sysconfdir=/etc"
$THOME/build/genpkg TRIBblix-slony12 slony1-2.2.10
