...
#
# 3.8.1 exists only to test that it builds and works
# no modules have yet been built against this version
#
${THOME}/build/dobuild Python-3.8.1 -P /usr/versions/python-3.8 -L -C --enable-shared
# Horrid hack to work around deficiencies in setuptools
${THOME}/build/genpkg TRIBv-python-38 Python-3.8.1
