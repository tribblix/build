...
#
env CPPFLAGS="-I/usr/gnu/include" TRIBBLIX_LDFLAGS="-L/usr/gnu/lib/`isainfo -k` -R/usr/gnu/lib/`isainfo -k`" ${THOME}/build/dobuild -64only aspell-0.60.8 -C "--sysconfdir=/etc --with-curses=ncurses"
