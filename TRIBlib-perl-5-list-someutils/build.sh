...
#
${THOME}/build/unpack List-SomeUtils-XS-0.59
cd List-SomeUtils-XS-0.59
perl Makefile.PL
make
cd ..
...
make
cd ..
${THOME}/build/genpkg TRIBlib-perl-5-list-someutils List-SomeUtils-0.59 List-SomeUtils-XS-0.59
