...
#
${THOME}/build/dobuild c_icap_modules-0.4.3 -P /opt/tribblix/c-icap -C "--with-c-icap=/opt/tribblix/c-icap --with-clamav=/opt/tribblix/clamav"
cd c_icap_modules-0.4.3
rm -fr /tmp/cm
