#!/bin/sh
#
# this gcc10 build is designed purely as a compiler for illumos-gate
...
# so it's only useful to find the gcc10 bugs in the source
#
# download the tarball like so
#
# wget https://github.com/illumos/gcc/archive/gcc-10.3.0-il-1.tar.gz
#

${THOME}/build/unpack gcc-10.3.0-il-1
mv gcc-gcc-10.3.0-il-1 gcc-10.3.0-il-1
cd gcc-10.3.0-il-1
...
rm -fr /tmp/gc10/opt/gcc/10.3.0/lib/gcc/i386-pc-solaris2.11/10.3.0/include-fixed
