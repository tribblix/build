...
gmake CFLAGS="-fpic -fPIC -Wall -Winline -O2 -m64"
...
rm /tmp/bb/usr/bin/{bzcat,bzip2,bunzip2,bzip2recover}
cp ../bzip2-1.0.6-64bit/bzip2-shared /tmp/bb/usr/bin/bzip2
cp ../bzip2-1.0.6-64bit/bzip2recover /tmp/bb/usr/bin/bzip2recover
