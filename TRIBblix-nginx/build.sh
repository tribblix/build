...
#
env CC="gcc -m64" ${THOME}/build/dobuild nginx-1.26.3 -P /opt/tribblix/nginx -C "--user=nginx --group=nginx --with-http_ssl_module --with-http_v2_module --with-http_stub_status_module --with-http_realip_module --with-http_v3_module"
${THOME}/build/genpkg TRIBblix-nginx nginx-1.26.3
