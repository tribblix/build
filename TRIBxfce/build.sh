...
$THOME/build/dobuild -gnu xfce4-panel-4.12.1 -C "--disable-debug"
$THOME/build/dobuild -gnu tumbler-0.1.31 -C "--disable-debug"
$THOME/build/dobuild -gnu Thunar-1.6.11 -C "--disable-debug"
$THOME/build/dobuild -gnu xfce4-settings-4.12.1 -C "--disable-debug"
...
(cd xfce4-panel-4.12.1 ; gmake DESTDIR=/tmp/xfu install)
(cd tumbler-0.1.31 ; gmake DESTDIR=/tmp/xfu install)
(cd Thunar-1.6.11 ; gmake DESTDIR=/tmp/xfu install)
(cd xfce4-settings-4.12.1 ; gmake DESTDIR=/tmp/xfu install)
