...
# package step
$THOME/build/dobuild -gnu libxfce4ui-4.16.1 -C "--disable-debug --with-vendor-info=Tribblix --enable-introspection=no"
# package step
...
# package step
$THOME/build/dobuild -gnu xfce4-settings-4.16.2 -C "--disable-debug"
$THOME/build/dobuild -gnu xfce4-appfinder-4.16.1 -C "--disable-debug"
$THOME/build/dobuild -gnu xfce4-panel-4.16.3 -C "--disable-debug --enable-introspection=no"
$THOME/build/dobuild -gnu xfdesktop-4.16.0 -C "--disable-debug"
$THOME/build/dobuild -gnu thunar-4.16.8 -C "--disable-debug --enable-introspection=no"
