...
# package step
$THOME/build/dobuild -64 -gnu xfce4-settings-4.16.5 -C "--disable-debug"
$THOME/build/dobuild -64 -gnu xfce4-appfinder-4.16.1 -C "--disable-debug"
$THOME/build/dobuild -64 -gnu xfce4-panel-4.16.6 -C "--disable-debug --enable-introspection=no"
$THOME/build/dobuild -64 -gnu xfdesktop-4.16.1 -C "--disable-debug"
