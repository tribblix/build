...
# and rerun gmake
#
${THOME}/build/cmbuild +gnu -64only clamav-1.0.9 -P /opt/tribblix/clamav -C "-DENABLE_MILTER=OFF -DENABLE_TESTS=OFF"
${THOME}/build/genpkg TRIBblix-clamav clamav-1.0.9
