...
#
$THOME/build/dobuild slony1-2.2.8 -P /opt/tribblix/postgres10 -C "--with-pgconfigdir=/opt/tribblix/postgres10/bin --sysconfdir=/etc"
$THOME/build/genpkg TRIBblix-slony10 slony1-2.2.8
