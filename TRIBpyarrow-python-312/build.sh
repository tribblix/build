...
# arrow build itself
#
env PYARROW_WITH_DATASET=1 PYARROW_WITH_PARQUET=1 PYARROW_WITH_JSON=1 PYARROW_WITH_CSV=1 PYARROW_WITH_FILESYSTEM=1 PYARROW_WITH_COMPUTE=1 CC="gcc -m64" FLAGS=-m64 CXXFLAGS="-m64 -D__STDC_NO_ATOMICS__=1" LDFLAGS=-m64 CMAKE_PREFIX_PATH=/usr/lib/amd64/cmake ${THOME}/build/pkg_pep518 -N TRIBpyarrow-python-312 pyarrow-23.0.1
