...
cd ~/ud
${THOME}/build/unpack jdk19-jdk-19-34
cd jdk19-jdk-19-34
...
# OpenJDK Runtime Environment (build 19-internal-adhoc.ptribble.jdk19-jdk-19-34)
# OpenJDK 64-Bit Server VM (build 19-internal-adhoc.ptribble.jdk19-jdk-19-34, mixed mode, sharing)
#
